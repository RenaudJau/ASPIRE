...
Var.barplot(variab = EssaiVariable,ylim = c(0.5,3))
...
Obj.radar.plot(obj = EssaiObjectif,limited = FALSE)
Obj.radar.plot(obj = EssaiObjectif,transp = 1)
Obj.radar.plot(obj = EssaiObjectif,transp = 0.1)
Obj.radar.plot(obj = EssaiObjectif,col = "c3")
Obj.radar.plot(obj = EssaiObjectif,col = "cadetblue")
...
Proj.radar.plot(proj = Cossure,transp = 1)
Proj.radar.plot(proj = Cossure,transp = 0.1)
Proj.radar.plot(proj = Cossure,col = "c3")
...
Proj.all.radar.plot(proj = Cossure,transp = 1)
Proj.all.radar.plot(proj = Cossure,transp = 0.1)
Proj.all.radar.plot(proj = Cossure,col = "c3")
...
Proj.all.radar.plot(proj = Cossure, AllInOne = FALSE, transp = 0.1)
Proj.all.radar.plot(proj = Cossure, AllInOne = FALSE, col = "c3")
...
wheelscores(lowercat = Obj_Var$Var,supercat = Obj_Var$Obj,
            scores = Cossure$Summary_All$Variables$mean_transf_value,
            val.max = 1,
...
ASPIRE_all_test <- ASPIRE_all(variable_df = don_test_var, objective_df = don_test_obj, project_df = don_test_proj)
